...
class ModelTest: XCTestCase {
    ...
    func testPostItemRequest() throws {
        ...
        XCTAssertEqual(postItemRequestData.descriptions, "Apple M1 칩은 13형 MacBook Pro에 믿을 수 없을 만큼의 속도와 파워를 선사합니다.최대 2.8배 향상된 CPU 성능, 최대 5배 빨라진 그래픽 속도, 최대 11배 빨라진 머신 러닝 성능을 구현하는 최첨단 Apple 제작 Neural Engine, 여기에 무려 20시간 지속되는 Mac 사상 가장 오래가는 배터리까지.외장은 Apple의 가장 사랑받는 프로용 노트북 그대로, 하지만 그 능력은 한 차원 더 높아졌습니다.")
    ...
    func testPostItemResponse() throws {
        ...
        XCTAssertEqual(postItemResponseData.descriptions, "Apple M1 칩은 13형 MacBook Pro에 믿을 수 없을 만큼의 속도와 파워를 선사합니다.")
    ...
    func testGetItemIdentityResponse() throws {
        ...
        XCTAssertEqual(getItemIdentityResponseData.descriptions, "Apple M1 칩은 13형 MacBook Pro에 믿을 수 없을 만큼의 속도와 파워를 선사합니다.")
    ...
    func testPatchItemIdentityResponse() throws {
        ...
        XCTAssertEqual(patchItemIdentityResponseData.descriptions, "Apple M1 칩은 13형 MacBook Pro에 믿을 수 없을 만큼의 속도와 파워를 선사합니다.")
