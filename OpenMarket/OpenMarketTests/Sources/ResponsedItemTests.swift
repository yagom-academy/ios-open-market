...
class ResponsedItemTests: XCTestCase {
    var sut: ResponsedItem!

    override func setUpWithError() throws {
//        sut = ResponsedItem(id: 1,
//                            title: "MacBook Pro",
...
//                            registrationDate: 1611523563.719116)
    ...
    func test_thumnails의_url_배열을_UIImage_배열로_변환할_수_있다() {
