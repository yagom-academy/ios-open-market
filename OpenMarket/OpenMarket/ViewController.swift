...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let marketItemForPost = MarketItemForPost(title: "Jacob's Mac", description: "제이콥의 맥북프로 16인치", price: 2500000, currency: "KRW", stock: 1, discountedPrice: 50000, images: dummyImages, password: "1234")
        OpenMarketAPIClient().postMarketIem(marketItemForPost) { result in
            ...
            case .success(let marketItem):
                ...
                print("discription: \(marketItem.description!)")
        ...
        // API 상품 수정 기능 사용 예시
        let marketItemForPatch = MarketItemForPatch(title: "Jacob's Mac", description: "가격 다운!", price: 1000000, currency: "KRW", stock: 1, discountedPrice: 50000, images: nil, password: "1234")
